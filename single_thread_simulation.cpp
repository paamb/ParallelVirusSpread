...
*/
void populate_grid(uint64_t* grid, int num_bits_to_place, int index){
...
int main(int argc, char *argv[]){
    ...
    for (int i = 0; i < 100; i++){
        ...
        populate_grid(healthy_grid, healthy_people, i);
        populate_grid(infected_grid, infected_people, i);
